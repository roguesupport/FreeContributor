...
The `example` folder have lists generated by FreeContributor for hosts, dnsmasq, pdnsd and unbound format. A cronjob example is present to automatically 
update the FreeContributor once a month.
