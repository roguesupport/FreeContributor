...
The `example` folder have lists generated by FreeContributor for hosts, dnsmasq, pdnsd and unbound format. 
A cronjob example is present to automatically update FreeContributor once a month.
...
The hosts blocking method can not use wildcards (*) and therefore someone must keep track 
...
| [Pi-Hole](https://github.com/pi-hole/pi-hole)                   | Bash, Php     | Dnsmasq                                        |
...
| [pfBlockerNG](https://forum.pfsense.org/index.php?topic=86212.0)| Shell, PHP    | Unbound                                        |
